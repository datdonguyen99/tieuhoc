window.jwplayer = (function (e) {
		...
		(i = []),
			(r = function () {
				...
				(y.reduce =
					...
					y.inject =
						function (e, t, n, i) {
							...
							if ((null == e && (e = []), u && e.reduce === u))
								return (
									i && (t = y.bind(t, i)), r ? e.reduce(t, n) : e.reduce(t)
								);
							if (
								(w(e, function (e, o, a) {
				...
				(y.size = function (e) {
					...
					(y.last = function (e, t, n) {
						if (null != e)
							return null == t || n
								? e[e.length - 1]
								: r.call(e, Math.max(e.length - t, 0));
					}),
				...
				(y.groupBy = L(function (e, t, n) {
					...
					(y.contains = y.include =
						function (e, t) {
							return (
								null != e &&
								(e.length !== +e.length && (e = y.values(e)),
								y.indexOf(e, t) >= 0)
							);
						}),
					...
					(y.max = function (e, t, n) {
						if (!t && y.isArray(e) && e[0] === +e[0] && e.length < 65535)
					...
					(y.indexOf = function (e, t, n) {
						...
						if (n) {
							if ("number" != typeof n)
								return (i = y.sortedIndex(e, t)), e[i] === t ? i : -1;
				...
				(y.bind = function (e, t) {
							...
							return (
								...
								c <= 0
									? (clearTimeout(a),
									  ...
									  (o = e.apply(i, r)),
									  (i = r = null))
									: a || n.trailing === !1 || (a = setTimeout(l, c)),
								o
							);
						};
					}),
					...
					(y.defaults = function (e) {
						return (
							w(r.call(arguments, 1), function (t) {
	...
	function (e, t, n) {
		...
		(i = [
			...
			(r = function (e, t, n, i, r, a, s, l, u, c, d, f, p) {
				var h = {};
				return (
					(h.log = function () {
						window.console &&
					...
					(h.foreach = function (e, t) {
						var n, i;
						for (n in e)
							"function" === h.typeOf(e.hasOwnProperty)
								? e.hasOwnProperty(n) && ((i = e[n]), t(n, i))
								: ((i = e[n]), t(n, i));
					}),
					(h.indexOf = t.indexOf),
					(h.noop = function () {}),
					...
					(h.prefix = e.prefix),
					(h.suffix = e.suffix),
					t.extend(h, a, s, u, n, l, i, r, c, d, f, p),
					h
				);
			}.apply(t, i)),
			!(void 0 !== r && (e.exports = r));
				...
				var t = [],
					...
					i = {
						...
						off: function (t, n, i) {
							...
							for (
								l = t ? [t] : e.keys(this._events), u = 0, c = l.length;
								u < c;
								u++
							)
			...
			(r = function (e, t, n, i) {
				function r(e, t) {
					return /touch/.test(e.type)
						? (e.originalEvent || e).changedTouches[0]["page" + t]
						: e["page" + t];
				}
				function o(e) {
				...
				function a(e, t, n) {
					...
					return (
						(i =
							t instanceof MouseEvent || (!t.touches && !t.changedTouches)
								? t
				...
				function s(e) {
					(e instanceof MouseEvent || e instanceof window.TouchEvent) &&
					...
					p = function (e, t) {
						...
						function p(t) {
							(d ||
								(u &&
									"touch" !== t.pointerType &&
									!e.contains(document.elementFromPoint(t.x, t.y)))) &&
								y(l.OUT, t);
						}
						function h(e, t, n) {
						...
						function g(n) {
							(w = n.target),
								...
								(C = r(n, "Y")),
								o(n) ||
									("pointerdown" === n.type && n.isPrimary
										? (t.preventScrolling &&
												((E = n.pointerId), e.setPointerCapture(E)),
										  h(e, "pointermove", v),
										  h(e, "pointercancel", m),
										  "mouse" === n.pointerType && "OBJECT" === w.nodeName
												? h(document, "mouseup", m)
												: h(e, "pointerup", m))
										: "mousedown" === n.type
										? (h(document, "mousemove", v),
										  f && "object" === n.target.nodeName.toLowerCase()
												? h(e, "click", m)
												: h(document, "mouseup", m))
										: "touchstart" === n.type &&
										  (h(w, "touchmove", v),
							...
							u
								? (e.addEventListener("pointerdown", g),
								  t.useHover &&
										...
										e.addEventListener("pointerout", p)),
								  t.useMove && e.addEventListener("pointermove", c))
								: (d &&
										(e.addEventListener("mousedown", g),
										t.useHover &&
											(e.addEventListener("mouseover", i),
											e.addEventListener("mouseout", p)),
										t.useMove && e.addEventListener("mousemove", c)),
							...
							(this.destroy = function () {
								this.off(),
									...
									w &&
										...
										(w = null)),
									u &&
										(t.preventScrolling && e.releasePointerCapture(E),
										e.removeEventListener("pointerover", i),
										e.removeEventListener("pointerdown", g),
										e.removeEventListener("pointermove", v),
										e.removeEventListener("pointermove", c),
										e.removeEventListener("pointercancel", m),
										e.removeEventListener("pointerout", p),
										e.removeEventListener("pointerup", m)),
				...
				return (
					(p.getPointerType = function (e) {
						return u && e instanceof window.PointerEvent
							? "touch" === e.pointerType
								? "touch"
								: "mouse"
							: c && e instanceof window.TouchEvent
							? "touch"
							: "mouse";
					}),
					n.extend(p.prototype, e),
					p
				);
			}.apply(t, i)),
			!(void 0 !== r && (e.exports = r));
	...
	function (e, t, n) {
		...
		(i = [n(1)]),
			(r = function (e) {
				function t(e) {
					return /[\(,]format=m3u8-/i.test(e)
						? "m3u8"
						: !!/[\(,]format=mpd-/i.test(e) && "mpd";
				}
				var n = function (e) {
					...
					r = function (e, t) {
						for (var n = 0; n < e.attributes.length; n++)
							if (
								e.attributes[n].name &&
								e.attributes[n].name.toLowerCase() === t.toLowerCase()
							)
				...
				var r = e.noop,
					...
					a = {
						...
						setState: function (e) {
							...
							(this.state = e),
								e !== i &&
									this.trigger(t.JWPLAYER_PLAYER_STATE, { newstate: e });
						},
			...
			(r = function (e) {
				...
				return (
					...
					(t.utf16BigEndianArrayToStr = function (e, t) {
						var n, i, r;
						for (n = "", r = e.length - 1, i = t || 0; i < r; )
							(254 === e[i] && 255 === e[i + 1]) ||
								(n += String.fromCharCode((e[i] << 8) + e[i + 1])),
								(i += 2);
						return n;
					}),
							...
							function (i, r) {
								if (
									...
									var o = r,
										...
										s = a.length;
									r = { value: { key: "", data: "" } };
									for (var l = 10; l < 14 && l < a.length && 0 !== a[l]; )
									...
									if (d > 0) {
										...
										if ("PRIV" === r.value.key) {
											if (
												"com.apple.streaming.transportStreamTimestamp" === p
											) {
										...
										var v = a[u];
										1 === v || 2 === v
											? (r.value.data = t.utf16BigEndianArrayToStr(a, u + 1))
											: (r.value.data = t.utf8ArrayToStr(a, u + 1));
									}
								}
								if (
									(n.hasOwnProperty(r.value.key) &&
										(i[n[r.value.key]] = r.value.data),
									r.value.info)
								) {
									var m = i[r.value.key];
									e.isObject(m) || ((m = {}), (i[r.value.key] = m)),
										(m[r.value.info] = r.value.data);
					...
					o = function (o, a) {
						...
						(this.addEventListener = this.on),
							...
							(this.load = function () {
								if (c === r.NEW) {
									var t = i[o];
									if (t && ((c = t.getStatus()), c < 2))
										return t.on(e.ERROR, s), void t.on(e.COMPLETE, l);
									var n =
									...
									(u.onload = u.onreadystatechange =
										function (e) {
											d ||
												...
												n && u.parentNode && !a && n.removeChild(u));
										}),
										(u.onerror = s),
	...
	function (e, t, n) {
		var i, r;
		(i = [n(1), n(2), n(17), n(28), n(94), n(29)]),
			(r = function (e, t, i, r, o, a) {
				function s(e, t, n, a) {
					var s,
						u,
						c = e.responseXML ? e.responseXML.firstChild : null;
					if (c)
						for (
							"xml" === i.localName(c) && (c = c.nextSibling);
							c.nodeType === c.COMMENT_NODE;

						)
							c = c.nextSibling;
					try {
						if (c && "tt" === i.localName(c))
							(s = o(e.responseXML)),
				...
				return {
					...
					textContent: function n(t) {
						...
						return (
							t &&
								(t.textContent
									? (n = e.trim(t.textContent))
									: t.text && (n = e.trim(t.text))),
							n
						);
					},
				...
				function i(t, n) {
					return "" === n || void 0 === n || null === n
						...
						? /png|gif|jpe?g/i.test(n) && n.indexOf("url") < 0
							? "url(" + n + ")"
							: n
						: 0 === n || "z-index" === t || "opacity" === t
						? "" + n
						: /color/i.test(t)
						? "#" + e.pad(n.toString(16).replace(/^0x/i, ""), 6)
						: Math.ceil(n) + "px";
				}
				var r,
					a = function (e, n, i, r) {
						...
						if ("object" === ("undefined" == typeof n ? "undefined" : o(n))) {
							...
							r && u && (u = u.replace(/;/g, " !important;")),
								(a = "{" + u + "}");
						} else "string" == typeof n && (a = n);
						return "" === a || "{}" === a
							? void t.clear(i, e)
							: void t.style([[e, e + a]], i);
					},
					s = function (e, t) {
						if (void 0 !== e && null !== e) {
							void 0 === e.length && (e = [e]);
								...
								if (void 0 !== l && null !== l)
									for (r in o)
										Object.prototype.hasOwnProperty.call(o, r) &&
											((s = n(r)), l.style[s] !== o[r] && (l.style[s] = o[r]));
							}
						}
					},
					l = function (e, t) {
			...
			(r = function (e) {
				...
				var l = (n.isIOS = function (e) {
					return i(
						e
							? new RegExp(
									"iP(hone|ad|od).+\\s(OS\\s" + e + "|.*\\sVersion/" + e + ")",
									"i"
							  )
							: /iP(hone|ad|od)/i
					);
				...
				var u = (n.isAndroid = function (e, t) {
					return (
						!(t && i(/chrome\/[123456789]/i) && !i(/chrome\/18/)) &&
						(e
							? (r(e) && !/\./.test(e) && (e = "" + e + "."),
							  i(new RegExp("Android\\s*" + e, "i")))
							: i(/Android/i))
					);
				});
				return (
					...
					(n.flashVersion = function () {
						...
						var e,
							t = navigator.plugins;
						if (t && ((e = t["Shockwave Flash"]), e && e.description))
							return parseFloat(
								e.description.replace(/\D+(\d+\.?\d*).*/, "$1")
							);
					...
					l = function (t) {
						...
						return (
							navigator.requestMediaKeySystemAccess &&
								(a = navigator.requestMediaKeySystemAccess.bind(navigator)),
							n
								? n.then(t)
	...
	function (e, t, n) {
		var i, r;
		(i = [n(2), n(38), n(90), n(1), n(3), n(108), n(4), n(5)]),
				...
				var l = function () {
						function o(e, t) {
							...
							switch (e) {
								...
								case a.JWPLAYER_MEDIA_TYPE:
									return void (
										r.get("mediaType") !== t.mediaType &&
										(r.set("mediaType", t.mediaType),
								...
								case a.JWPLAYER_MEDIA_META:
									...
									i.isNumber(l) &&
										!i.isNaN(l) &&
										(r.set("duration", l), this.set("duration", l));
									break;
								...
								case a.JWPLAYER_MEDIA_TIME:
									r.set("position", t.position),
										...
										i.isNumber(t.duration) &&
											(r.set("duration", t.duration),
								...
								case a.JWPLAYER_MEDIA_COMPLETE:
									return (
										(h = !0),
										this.mediaController.trigger(
											a.JWPLAYER_MEDIA_BEFORECOMPLETE,
											n
										),
										void (g && this.playbackComplete())
									);
								case a.JWPLAYER_AUDIO_TRACKS:
									this.setCurrentAudioTrack(t.currentTrack, t.tracks),
										r.set("audioTracks", t.tracks);
									break;
								...
								case "autoplayFailed":
									this.set("autostartFailed", !0),
										r.get("state") === s.PLAYING && r.set("state", s.PAUSED);
							}
							this.mediaController.trigger(e, n);
						}
						function l() {
							return (
								!!e.isIOS() &&
								!(e.isIOS(6) || e.isIOS(7) || e.isIOS(8) || e.isIOS(9))
							);
						}
						function c() {
							var t =
									!p.get("advertising") ||
									p.get("advertising").autoplayadsmuted,
						...
						(this.mediaController = i.extend({}, r)),
							...
							(this.setQualityLevel = function (e, t) {
								e > -1 &&
									t.length > 1 &&
									"youtube" !== f.getName().name &&
									this.mediaModel.set("currentLevel", parseInt(e));
							}),
							...
							(this.setCurrentAudioTrack = function (e, t) {
								e > -1 &&
									t.length > 0 &&
									e < t.length &&
									this.mediaModel.set("currentAudioTrack", parseInt(e));
							}),
							...
							(this.changeVideoProvider = function (e) {
								if (
									...
									f &&
										...
										f.getContainer() && f.remove(),
										delete f.instreamMode),
									!e)
								)
									return (f = v = e), void this.set("provider", void 0);
								v = new e(p.get("id"), p.getConfiguration());
								var t = this.get("mediaContainer");
								t
									? v.setContainer(t)
									: this.once("change:mediaContainer", this.onMediaContainer),
									this.set("provider", v.getName()),
									v.getName().name.indexOf("flash") === -1 &&
										(this.set("flashThrottle", void 0),
										this.set("flashBlocked", !1)),
									(f = v),
									f.volume(p.get("volume")),
									f.mute(this.autoStartOnMobile() || p.get("mute")),
									f.on("all", o, this),
									this.get("instreamMode") === !0 && (f.instreamMode = !0),
									this.set("renderCaptionsNatively", f.renderNatively);
							}),
							...
							(this.attachMedia = function () {
								return (
									...
									f.off("all", o, this),
									f.on("all", o, this),
									h && this.playbackComplete(),
									f.attachMedia()
								);
							}),
							(this.playbackComplete = function () {
								(h = !1),
									f.setState(s.COMPLETE),
							...
							(this.setActiveItem = function (t) {
								this.mediaModel.off(),
									...
									this.set(
										"duration",
										(t.duration && e.seconds(t.duration)) || 0
									),
									this.setProvider(t);
							}),
							(this.setProvider = function (e) {
								...
								if (void 0 !== t) {
									...
									(n && v instanceof n) || p.changeVideoProvider(n),
										v && (v.init && v.init(e), this.trigger("itemReady", e));
								}
							}),
							...
							(this.setVideoSubtitleTrack = function (e, t) {
								this.set("captionsIndex", e),
									...
									f && f.setSubtitlesTrack && f.setSubtitlesTrack(e);
							}),
				...
				return function (e, n, i) {
					if (((n = t(n)), (i = t(i)), n !== i)) {
						...
						"play" === r
							...
							: "pause" === r && (o.pauseReason = e.get("pauseReason")),
							this.trigger(r, o);
					}
				};
			}.apply(t, i)),
		...
		(i = [n(2), n(7)]),
			(r = function (e, t) {
				function n(e) {
					...
					var r = 1;
					if (
						(n[0].indexOf(" --> ") > 0 && (r = 0), n.length > r + 1 && n[r + 1])
					) {
						var o = n[r],
							a = o.indexOf(" --> ");
						a > 0 &&
							((t.begin = i(o.substr(0, a))),
		...
		(i = [n(1), n(47), n(97)]),
			(r = function (e, t, n) {
				...
				return function (r) {
					...
					var o = e.extend({}, i, r);
					e.isObject(o.sources) &&
						!e.isArray(o.sources) &&
						(o.sources = [t(o.sources)]),
						(e.isArray(o.sources) && 0 !== o.sources.length) ||
							(r.levels ? (o.sources = r.levels) : (o.sources = [t(r)]));
					for (var a = 0; a < o.sources.length; a++) {
						var s = o.sources[a];
						if (s) {
							var l = s["default"];
							l
								? (s["default"] = "true" === l.toString())
								: (s["default"] = !1),
					...
					return (
						(o.sources = e.compact(o.sources)),
						e.isArray(o.tracks) || (o.tracks = []),
						e.isArray(o.captions) &&
							((o.tracks = o.tracks.concat(o.captions)), delete o.captions),
	...
	function (e, t, n) {
		...
		(i = [n(1), n(33)]),
			(r = function (e, t) {
				...
				var r = {};
				return (
					(r.getAbsolutePath = function (e, i) {
						...
						try {
							"DOMParser" in window
								? ((t = new window.DOMParser().parseFromString(e, "text/xml")),
								  (i(t.childNodes) ||
										(t.childNodes && i(t.childNodes[0].childNodes))) &&
										(t = null))
		...
		(i = [n(23), n(14), n(1), n(102), n(25)]),
			(r = function (e, t, n, i, r) {
				...
				function a(i, o) {
					...
					return (
						i.mediaTypes &&
							(l = n.all(i.mediaTypes, function (e) {
								return s.isTypeSupported(e);
							})),
						l &&
							("dash" === i.type ||
								"mpd" === i.type ||
								(i.file || "").indexOf("mpd-time-csf") > -1)
					);
				}
						...
						if (i && e.drm && "hls" === e.type) {
							...
							if (o && e.drm.fairplay) {
								...
								return (
									a &&
									a.isTypeSupported &&
									a.isTypeSupported("com.apple.fps.1_0", "video/mp4")
								);
							}
							return o;
						}
					...
					t.extend(e.prototype, {
						reorderProviders: function (e) {
							...
							return (
								"flash" !== e
									? i(t, "hlsjs", "flash")
									: (i(t, "flash", "hlsjs"), i(t, "hlsjs", "html5")),
								t
							);
						},
	...
	function (e, t, n) {
		...
		(i = function (require, e, t) {
			...
			function s(e) {
				...
				return (
					(t.type = "text/css"), t.setAttribute("data-jwplayer-id", e), a(t), t
				);
			}
			function l(e, t) {
				var n,
					...
					return (
						...
						n.each(e, function (e) {
							(e = n.extend({}, e)),
								...
								e.sources.length &&
									((e.file = e.sources[0].file),
									a && (e.preload = e.preload || a),
									i && (e.feedData = u),
									r.push(e));
						}),
						r
				...
				var s = function (e, i) {
						...
						return n.compact(
							n.map(r, function (e) {
								...
								return (
									n.isUndefined(i) || (e.withCredentials = i),
									c && (e.hlsjsdefault = c),
									t(e)
								);
							})
			...
			(r = function (e, t, n) {
				...
				return function (r) {
					if (r && r.file) {
						...
						if (
							(a.test(o.type) &&
								((o.mimeType = o.type), (o.type = o.type.replace(a, "$1"))),
							e.isYouTube(o.file)
								? (o.type = "youtube")
								: e.isRtmp(o.file)
								? (o.type = "rtmp")
								: o.type || (o.type = t.extension(o.file)),
							o.type)
						) {
							switch (o.type) {
								case "m3u8":
					...
					l = function (l) {
						...
						(this.load = function () {
							if (m === r.loaderstatus.NEW) {
								if (l.lastIndexOf(".swf") > 0)
									return (
										(f = l),
										(m = r.loaderstatus.COMPLETE),
										void v.trigger(n.COMPLETE)
									);
								if (t.getPluginPathType(l) === t.pluginPathType.CDN)
									return (
										(m = r.loaderstatus.COMPLETE), void v.trigger(n.COMPLETE)
									);
							...
							(this.getFlashPath = function () {
								if (f)
									switch (t.getPluginPathType(f)) {
										case t.pluginPathType.ABSOLUTE:
											return f;
										case t.pluginPathType.RELATIVE:
											return l.lastIndexOf(".swf") > 0
												? e.getAbsolutePath(f, window.location.href)
												: e.getAbsolutePath(f, u());
									}
								return null;
							}),
							(this.getJS = function () {
							...
							(this.getPluginmode = function () {
								return void 0 !==
									("undefined" == typeof f ? "undefined" : o(f)) &&
									void 0 !== ("undefined" == typeof p ? "undefined" : o(p))
									? s.HYBRID
									: void 0 !== ("undefined" == typeof f ? "undefined" : o(f))
									? s.FLASH
									: void 0 !== ("undefined" == typeof p ? "undefined" : o(p))
									? s.JAVASCRIPT
									: void 0;
		...
		(i = [n(1), n(31)]),
			(r = function (e, t) {
					...
					return function (n) {
						...
						if ((clearTimeout(e.timeoutId), e.responseType)) {
							...
							if (
								...
								i.responseText &&
								!o &&
								((o = t.parseXML(i.responseText)), o && o.firstChild)
							)
								return s(i, o, e);
				...
				function a(t, n) {
					if (
						!t.response ||
						(e.isString(t.response) && '"' !== t.responseText.substr(1))
					)
						try {
				...
				function s(t, n, i) {
					...
					return i.requireValidXML &&
						("parsererror" === r.nodeName ||
							r.getElementsByTagName("parsererror").length)
						? void i.onerror("Invalid XML", i.url, t)
						: (t.responseXML || (t = e.extend({}, t, { responseXML: n })),
						  i.oncomplete(t));
				}
				var l = function () {},
					u = !1,
					...
					d = function (t, a, s, d) {
						...
						if ("XDomainRequest" in window && c(t))
							(f = p.xhr = new window.XDomainRequest()),
								(f.onload = o(p)),
								(f.ontimeout = f.onprogress = l),
								(u = !0);
						else {
							if (!("XMLHttpRequest" in window)) return void p.onerror("", t);
							(f = p.xhr = new window.XMLHttpRequest()),
								(f.onreadystatechange = r(p));
						}
						var h = i("Error loading file", p);
						(f.onerror = h),
							"overrideMimeType" in f
								? p.mimeType && f.overrideMimeType(p.mimeType)
								: (u = !0);
						try {
			...
			(r = function (e, t, n) {
				...
				function a(a, s, c, d) {
					...
					if (((d = d || "opaque"), e.isMSIE())) {
						...
						for (var g = s.getElementsByTagName("object"), v = g.length; v--; )
							g[v].id === c && (f = g[v]);
					} else
						(f = document.createElement("object")),
							...
							f.setAttribute("bgcolor", u),
							f.setAttribute("id", c),
							f.setAttribute("name", c),
							i(f, "allowfullscreen", "true"),
							i(f, "allowscriptaccess", "always"),
							i(f, "wmode", d),
							i(f, "menu", "false"),
							s.appendChild(f, s);
					(f.className = "jw-swf jw-reset"),
					...
					return (
						...
						r(f, "off", function () {
							...
							return (
								e.length || ((f._eventQueue.length = 0), clearTimeout(m)),
								t.off.apply(f, e)
							);
						}),
						r(f, "trigger", function (e, n) {
							var i = f._eventQueue;
							i.push({ type: e, json: n }),
								m > -1 ||
						...
						r(f, "_events", {}),
						r(f, "triggerFlash", function (t) {
							if (
								("setupCommandQueue" === t && (p = !1),
								("setup" !== t && p) || !f.__externalCall)
							) {
							...
							return s instanceof e.Error &&
								(console.error(t, s), "setup" === t)
								? ((s.name = "Failed to setup flash"), s)
								: f;
						}),
						r(f, "__commandQueue", []),
						f
	...
	function (e, t, n) {
		var i, r;
		(i = [n(19), n(1), n(33), n(31), n(24)]),
			(r = function (e, t, n, i, r) {
				var o = {};
				return (
					(o.repo = t.memoize(function () {
						var t = r.split("+")[0],
							i = e.repo + t + "/";
	...
	function (e, t, n) {
		...
		(t.generateLabel = i),
			(t.createLabel = r),
			(t.getCustomLabel = o),
			(t.findClosestBandwidth = a),
			(t.toKbps = s),
			(t.hasRedundantLevels = l);
	},
	function (e, t) {
		"use strict";
		Object.defineProperty(t, "__esModule", { value: !0 });
		...
		(i = []),
			(r = function () {
				var e = function (e) {
					...
					i = function (e) {
						for (
							var t = new Array(Math.ceil(e.length / 4)), n = 0;
							n < t.length;
							n++
						)
							t[n] =
				...
				var o = function (o, a) {
					...
					s.setup = function () {
						l.call(this),
							...
							a.change("castAvailable", this.onCastAvailable, this),
							a.change("castActive", this.onCastActive, this);
					};
					var u = s.addControls;
					return (
						(s.addControls = function (e) {
							u.call(this, e);
							var t = this.controlsContainer();
							t &&
								this._skipButton &&
								t.appendChild(this._skipButton.element());
						}),
						(s.addSkipButton = function () {
							(this._skipButton = new i(this.instreamModel)),
								this._skipButton.on(
									n.JWPLAYER_AD_SKIPPED,
									function () {
										this.api.skipAd();
									},
									this
						...
						(s.onSkipButton = function (e, t) {
							t
								? this.addSkipButton()
								: this._skipButton &&
								  (this._skipButton.destroy(), (this._skipButton = null));
						}),
						...
						(s.onCastAvailable = function (t, n) {
							var i = t.get("cast");
							r.isObject(i) &&
								e.toggleClass(this.getContainer(), "jw-flag-cast-available", n);
						}),
						s
					);
				};
				...
				var d = function (d, f) {
					...
					o.extend(this, n),
						...
						(this.trigger = function (e, t) {
							...
							return i && i.debug
								? n.trigger.call(h, e, t)
								: n.triggerSafe.call(h, e, t);
						}),
			...
			(r = function (e, t) {
				...
				var a = {
					...
					s = function (s, l) {
						...
						i(c),
							(c.localization = t.extend({}, a.localization, c.localization));
						var d = t.extend({}, a, c);
						...
						(d.flashplayer = d.flashplayer || f + "jwplayer.flash.swf"),
							(d.flashloader = d.flashloader || f + "jwplayer.loader.swf"),
							"http:" === window.location.protocol &&
								((d.flashplayer = d.flashplayer.replace("https", "http")),
								(d.flashloader = d.flashloader.replace("https", "http"))),
							(d.aspectratio = o(d.aspectratio, d.width)),
							t.isObject(d.skin) &&
								((d.skinUrl = d.skin.url),
							...
							t.isString(d.skin) &&
								d.skin.indexOf(".xml") > 0 &&
								(console.warn(
									"JW Player does not support XML skins, please update your config"
								),
								(d.skin = d.skin.replace(".xml", ""))),
							d.aspectratio || delete d.aspectratio;
						var p = d.playlist;
						if (p)
							t.isArray(p.playlist) &&
								((d.feedData = p), (d.playlist = p.playlist));
						else {
							var h = t.pick(d, [
								"title",
								"description",
				...
				var o = [],
					...
					s = function (t) {
						...
						return (
							t
								? "string" == typeof t
									? ((n = l(t)), n || (i = document.getElementById(t)))
									: "number" == typeof t
									? (n = o[t])
									: t.nodeType && ((i = t), (n = l(i.id)))
								: (n = o[0]),
							n ? n : i ? u(new e(i, c)) : { registerPlugin: r.registerPlugin }
						);
					},
					l = function (e) {
			...
			(r = function (e, t, n, i) {
				var r = function (t, r, o, a) {
					function s() {
						f(
							"Setup Timeout Error",
							"Setup took longer than " + v + " seconds to complete."
						);
					}
					function l() {
						for (var e in g)
					...
					function d(e, t) {
						"error" === t.type
							? f(t.msg, t.reason)
							: "complete" === t.type
							? (clearTimeout(p), h.trigger(i.JWPLAYER_READY))
							: ((e.complete = !0), l());
					}
					function f(e, t) {
						clearTimeout(p),
							h.trigger(i.JWPLAYER_SETUP_ERROR, { message: e + ": " + t }),
							h.destroy();
					}
					var p,
						h = this,
				...
				var i = function (i, r) {
						...
						if (!r.get("renderCaptionsNatively") && i) {
							...
							for (o = 0; o < i; o++)
								(s = n[o]),
									l(s.kind) &&
										!m[s._id] &&
										(f(s), t.loadFile(s, u.bind(null, s), c));
						}
						var d = p();
					...
					function h() {
						...
						for (var n = 0; n < v.length; n++) {
							...
							i["default"] || i.defaulttrack || "default" === i._id
								? (e = n + 1)
								: i.autoselect;
						}
						g(e);
	...
	function (e, t, n) {
		...
		(i = [
			...
			(r = function (e, t, n, i, r, a, s, l, u, c, d, f, p, h, g, v, m, y) {
				function w(e) {
					return function () {
						var t = Array.prototype.slice.call(arguments, 0);
						this._model.getVideo()
					...
					(b.prototype = {
						...
						setup: function (a, v) {
							...
							function L() {
								...
								e && e.on("nextUp", fe.setNextUp, fe),
									se.once(g.JWPLAYER_RESIZE, C),
									se.init();
							}
							function C() {
								fe.change("visibility", j),
									fe.on("change:controls", A),
									ge.trigger(g.JWPLAYER_READY, { setupTime: 0 }),
									(ge.triggerAfterReady = ge.trigger);
								for (var e = 0; e < we.length; e++) {
									var t = we[e];
									(pe = t.type === g.JWPLAYER_MEDIA_BEFOREPLAY),
										ge.trigger(t.type, t.args),
										(pe = !1);
								}
							...
							function P(e, t) {
								fe.get("playOnViewable") &&
									(t ? O() : c.isMobile() && ge.pause({ reason: "autostart" }));
							}
							function _(e) {
								...
								return t.load(n).then(function () {
									ge.getProvider() ||
										(fe.setProvider(fe.get("playlistItem")), R());
								});
							}
							function R() {
							...
							function x(e, t) {
								switch (
									(fe.get("state") === h.ERROR && fe.set("state", h.IDLE),
									fe.set("preInstreamState", "instream-idle"),
									ge.trigger("destroyPlugin", {}),
									D(!0),
									fe.once("itemReady", k),
							...
							function M(e) {
								if (
									(e && fe.set("playReason", e.reason),
									fe.get("state") !== h.ERROR)
								) {
									var t = S();
									if (n.isString(t)) return void v.pauseAd(!1);
									if (
										(fe.get("state") === h.COMPLETE && (D(!0), B(0)),
										!pe &&
											((pe = !0),
											ge.triggerAfterReady(g.JWPLAYER_MEDIA_BEFOREPLAY, {
												playReason: fe.get("playReason"),
											}),
											(pe = !1),
											de))
									)
										return (de = !1), void (ce = null);
									var i;
									if (Y()) {
							...
							function O() {
								var e = fe.get("state");
								(e !== h.IDLE && e !== h.PAUSED) || M({ reason: "autostart" });
							}
							function D(e) {
								fe.off("itemReady", k);
								var t = !e;
							...
							function N(e) {
								(ce = null),
									e &&
										(fe.set("pauseReason", e.reason),
										("interaction" !== e.reason && "external" !== e.reason) ||
											fe.set("playOnViewable", !1));
								var t = S();
							...
							function W(e, t) {
								fe.get("state") !== h.ERROR &&
									(fe.get("scrubbing") || fe.get("state") === h.PLAYING || M(t),
									ve().seek(e));
							}
							function F(e, t) {
								D(!0),
							...
							function J(e, t) {
								...
								var i = l(e);
								return (
									(i = l.filterPlaylist(i, fe, t)),
									fe.set("playlist", i),
									n.isArray(i) && 0 !== i.length
										? (_(i), !0)
										: (ge.triggerError({
												message:
							...
							function V(e) {
								F(fe.get("item") - 1, e || { reason: "external" });
							}
							function U(e) {
								F(fe.get("item") + 1, e || { reason: "external" });
							}
							function H() {
								if (Y()) {
									...
									ce = H;
									var e = fe.get("item");
									return e === fe.get("playlist").length - 1
										? void (fe.get("repeat")
												? U({ reason: "repeat" })
												: (c.isIOS() && oe(!1),
												  fe.set("playOnViewable", !1),
												  fe.set("state", h.COMPLETE),
												  ge.trigger(g.JWPLAYER_PLAYLIST_COMPLETE, {})))
										: void U({ reason: "playlist" });
								}
							}
							function z(e) {
							...
							function X(e) {
								ve() &&
									((e = parseInt(e, 10) || 0), ve().setCurrentAudioTrack(e));
							}
							function $() {
							...
							function ee(e) {
								(e = parseInt(e, 10) || 0),
									fe.persistVideoSubtitleTrack(e),
									ge.trigger(g.JWPLAYER_CAPTIONS_CHANGED, {
										tracks: ne(),
										track: e,
									});
							}
							...
							function re() {
								...
								return e instanceof c.Error
									? void c.log("Error calling _attachMedia", e)
									: void ("function" == typeof ce && ce());
							}
							function oe(e) {
								n.isBoolean(e) || (e = !fe.get("fullscreen")),
									fe.set("fullscreen", e),
									this._instreamAdapter &&
										this._instreamAdapter._adModel &&
										this._instreamAdapter._adModel.set("fullscreen", e);
							}
							function ae() {
								var e = v.getPlugin("related");
								e && e.next();
							...
							var ye = new e(a, me),
								we = [];
							fe.setup(ye, me),
								(se = this._view = new d(v, fe)),
								(ue = new i(v, fe, se, J)),
								ue.on(g.JWPLAYER_READY, L, this),
								ue.on(g.JWPLAYER_SETUP_ERROR, this.setupError, this),
								fe.mediaController.on("all", w, this),
								fe.mediaController.on(g.JWPLAYER_MEDIA_COMPLETE, function () {
									n.defer(H);
								}),
								fe.mediaController.on(
								...
								fe.on("change:state", p, this),
								fe.on("change:duration", function (e, t) {
								...
								fe.on("change:fullscreen", function (e, t) {
									ge.trigger(g.JWPLAYER_FULLSCREEN, { fullscreen: t }),
								...
								fe.on(
									...
									function (e, t) {
										if (t) {
											var n =
												this.currentContainer.querySelector("video, audio");
								...
								fe.on("change:inDom", function (e, t) {
								...
								(this._prev = V),
								(this._item = F),
								(this._setCurrentCaptions = ee),
								(this._setCurrentQuality = z),
								(this._setFullscreen = oe),
								(this.detachMedia = ie),
								(this.attachMedia = re),
								(this.getCurrentQuality = G),
								(this.getQualityLevels = Q),
								(this.setCurrentAudioTrack = X),
								(this.getCurrentAudioTrack = $),
								(this.getAudioTracks = Z),
								(this.getCurrentCaptions = te),
								(this.getCaptionsList = ne),
								(this.getVisualQuality = K),
								(this.getConfig = q),
								(this.getState = I),
								(this.setVolume = fe.setVolume.bind(fe)),
								(this.setMute = fe.setMute.bind(fe)),
								...
								(this.resize = se.resize),
								(this.getSafeRegion = se.getSafeRegion),
								(this.setCues = se.addCues),
								(this.setCaptions = se.setCaptions),
								(this.next = ae),
								...
								(this.removeButton = function (e) {
									var t = fe.get("dock") || [];
									(t = n.reject(t, n.matches({ id: e }))), fe.set("dock", t);
								}),
								...
								(this.setControls = function (e) {
									n.isBoolean(e) || (e = !fe.get("controls")),
										fe.set("controls", e);
									var t = fe.getVideo();
									t && t.setControls(e);
								}),
								...
								(this.createInstream = function () {
									return (
										...
										(this._instreamAdapter = new t(this, fe, se)),
										this._instreamAdapter
									);
								}),
						...
						showView: function (e) {
							...
							this.currentContainer.parentElement &&
								this.currentContainer.parentElement.replaceChild(
									e,
						...
						setupError: function (e) {
							var t = e.message,
								i = c.createElement(
									v(this._model.get("id"), this._model.get("skin"), t)
								),
	...
	function (e, t, n) {
		var i, r;
		(i = [n(89), n(88), n(4), n(5), n(2), n(3), n(1)]),
			(r = function (e, t, n, i, r, o, a) {
				...
				var l = { skipoffset: null, tag: null },
					u = function (e, o, u) {
						function c() {
							E._adModel.set("state", "buffering"),
								o.set("skipButton", !1),
								b++;
							var e,
								t = h[b];
						...
						function f(e) {
							E._adModel.set("duration", e.duration),
								E._adModel.set("position", e.position);
						}
						function p(e) {
							var t = {};
							A.tag && (t.tag = A.tag),
						...
						var h,
							...
							C = a.bind(function (e) {
								(e = e || {}),
									...
									E &&
										E._adModel &&
										(E._adModel.get("state") === i.PAUSED
											? e.hasControls && E.instreamPlay()
											: E.instreamPause());
							}, this),
							j = a.bind(function () {
								E &&
						...
						(this.type = "instream"),
							(this.init = function (t) {
								(v = o.getVideo()),
									(m = o.get("position")),
									(y = o.get("playlist")[o.get("item")]),
									E.on("all", d, this),
									E.on(n.JWPLAYER_MEDIA_TIME, f, this),
									E.on(n.JWPLAYER_MEDIA_COMPLETE, p, this),
									E.init(),
									e.detachMedia(),
									o.mediaModel.set("state", i.BUFFERING),
									e.checkBeforePlay() || (0 === m && !o.checkComplete())
										? ((m = 0), o.set("preInstreamState", "instream-preroll"))
										: (v && o.checkComplete()) || o.get("state") === i.COMPLETE
										? o.set("preInstreamState", "instream-postroll")
										: o.set("preInstreamState", "instream-midroll");
								var a = o.get("state");
								return (
									t || (a !== i.PLAYING && a !== i.BUFFERING) || v.pause(),
									u.setupInstream(E._adModel),
									E._adModel.set("state", i.BUFFERING),
									u.clickHandler() &&
						...
						var k = function (e) {
							h && b + 1 < h.length
								...
								: (this.trigger("adBreakEnd", {}),
								  e.type === n.JWPLAYER_MEDIA_COMPLETE &&
						...
						(this.loadItem = function (e, i) {
							...
							var s = e;
							a.isArray(e)
								? ((h = e), (g = i), (e = h[b]), g && (i = g[b]))
								: (s = [e]);
							var u = o.getProviders(),
								c = w === t ? "flash" : void 0,
								d = u.required(s, c);
							o.set("hideAdsControls", !1),
								u.load(d).then(function () {
									if (null !== E) {
										L.trigger(n.JWPLAYER_PLAYLIST_ITEM, { index: b, item: e }),
											(A = a.extend({}, l, i)),
											E.load(e),
											L.addClickHandler();
							...
							(this.setupSkipButton = function (e, t, n) {
								o.set("skipButton", !1),
									n && (k = n),
									E._adModel.set("skipMessage", t.skipMessage),
									E._adModel.set("skipText", t.skipText),
									E._adModel.set("skipOffset", e),
									o.set("skipButton", !0);
							}),
							...
							(this.addClickHandler = function () {
								u.clickHandler() &&
									u.clickHandler().setAlternateClickHandlers(C, j),
									E.on(n.JWPLAYER_MEDIA_META, this.metaHandler, this);
							}),
							(this.skipAd = function (e) {
								var t = n.JWPLAYER_AD_SKIPPED;
								this.trigger(t, e), k.call(this, { type: t });
							}),
							...
							(this.destroy = function () {
								if ((this.off(), o.set("skipButton", !1), E)) {
									u.clickHandler() &&
										u.clickHandler().revertAlternateClickHandlers(),
										o.off(null, null, E),
										E.off(null, null, L),
										E.instreamDestroy(),
										u.destroyInstream(),
									...
									switch (t) {
										...
										case "instream-midroll":
											...
											(n.starttime = m),
												o.loadVideo(n),
												r.isMobile() &&
													o.mediaModel.get("state") === i.BUFFERING &&
													v.setState(i.BUFFERING),
												v.play();
											break;
	...
	function (e, t, n) {
		var i, r;
		(i = [n(3), n(26), n(27), n(4), n(5), n(2), n(1)]),
			(r = function (e, t, n, i, r, o, a) {
				var s = function (e, i) {
					(this.model = i),
							...
							init: function () {
								if (o.isChrome()) {
									...
									this.swf.on(
										"throttle",
										function (n) {
											if ((clearTimeout(e), "resume" === n.state))
												t && ((t = !1), this.instreamPlay());
											else {
												var i = this;
								...
								this.swf
									.on("instream:state", this.stateHandler, this)
									.on(
										"instream:time",
										function (e) {
		...
		(i = [n(1), n(3), n(27), n(4), n(5), n(26)]),
			(r = function (e, t, n, i, r, o) {
				var a = function (a, s) {
						...
						if (p !== r) {
							...
							r.off(),
								r.on(
									"all",
									function (t, n) {
										(o && t === i.JWPLAYER_MEDIA_COMPLETE) ||
											this.trigger(t, e.extend({}, n, { type: t }));
									},
									h
								),
					...
					function c(e) {
						s.trigger(e.type, e),
							h.trigger(i.JWPLAYER_FULLSCREEN, { fullscreen: e.jwstate });
					}
					function d() {
						f.getVideo().play();
					}
					...
					return (
						...
						(this.init = function () {
							(f = new o().setup({
								...
								f.on("fullscreenchange", c),
								(this._adModel = f);
						}),
						(h.load = function (e) {
							f.set("item", 0),
								f.set("playlistItem", e),
								f.setActiveItem(e),
								l(),
								f.off(i.JWPLAYER_ERROR),
								f.on(
									i.JWPLAYER_ERROR,
									function (e) {
						...
						(this.instreamDestroy = function () {
							f &&
								(f.off(),
								this.off(),
								p && (p.detachMedia(), p.off(), f.getVideo() && p.destroy()),
								(f = null),
	...
	function (e, t, n) {
		...
		(i = [n(62), n(1)]),
			(r = function (e, t) {
				...
				function r(t) {
					function n(t, n, r) {
						t._qoeItem && r && t._qoeItem.end(r.get("state")),
							(t._qoeItem = new e()),
							...
							i(t),
							n.on("change:state", function (e, n, i) {
	...
	function (e, t, n) {
		var i, r;
		(i = [n(18), n(45), n(13), n(58), n(19), n(1), n(2), n(4), n(43)]),
			(r = function (e, t, i, r, o, a, s, l, u) {
				function c() {
					var e = {
				...
				function g(t, n) {
					(window.jwplayerPluginJsonp = e.registerPlugin),
						(x = e.loadPlugins(n.get("id"), n.get("plugins"))),
						x.on(l.COMPLETE, t),
						x.on(l.ERROR, a.partial(m, t)),
						x.load();
				}
				function v(e, t, n) {
				...
				function y(e, n) {
					...
					a.isString(i)
						? ((T = new t()),
						  T.on(l.JWPLAYER_PLAYLIST_LOADED, function (t) {
								(n.attributes.feedData = t),
									(n.attributes.playlist = t.playlist),
									e();
						  }),
						  T.on(l.JWPLAYER_ERROR, a.partial(b, e)),
						  T.load(i))
						: e();
				}
				function w(e, t, n, i) {
					...
					if (o && a) {
						...
						d.parentElement || c();
						var p =
								"" + t.get("id") + "-" + Math.random().toString(16).substr(2),
							h = t.get("flashloader");
				...
				function b(e, t) {
					t && t.message
						? R(e, "Error loading playlist", t.message)
						: R(e, "Error loading player", "No playable sources found");
				}
				function A(e, t) {
					var n;
					return (
						a.contains(o.SkinsLoadable, e) && (n = t + "skins/" + e + ".css"), n
					);
				}
				function L(e) {
				...
				function j(e, t, n, i) {
					...
					r && t.set("autostartMuted", !0),
						t.set("playOnViewable", r || "viewable" === t.get("autostart")),
						i.setup(),
						e();
				}
				function k(e, t) {
		...
		(i = [n(7)]),
			(r = function (e) {
				...
				return function (r) {
					...
					t(a),
						a.length ||
							((a = r.getElementsByTagName("tt:p")),
							a.length || (a = r.getElementsByTagName("tts:p")));
					for (var c = 0; c < a.length; c++) {
						for (
							var d = a[c], f = d.getElementsByTagName("br"), p = 0;
							p < f.length;
							p++
						) {
							var h = f[p];
						...
						if (v) {
							var m = d.getAttribute("begin"),
								...
								E = { begin: i(m, s), text: v };
							w ? (E.end = i(w, s)) : y && (E.end = E.begin + i(y, s)),
								o.push(E);
						}
					}
					return o.length || n(), o;
						...
						for (
							...
							if (h.prefix === i) {
								...
								"source" === g
									...
									: ((o[g] = n.serialize(e.textContent(h))),
									  "file" === g && o.sources && delete o.sources);
							}
							o[d] || (o[d] = o.link);
						}
						if (a.length)
							for (o.sources = [], p = 0; p < a.length; p++)
								a[p].file.length > 0 &&
									((a[p][u] = "true" === a[p][u]),
									a[p].label.length || delete a[p].label,
									o.sources.push(a[p]));
						if (s.length)
							for (o.tracks = [], p = 0; p < s.length; p++)
								s[p].file.length > 0 &&
									((s[p][u] = "true" === s[p][u]),
									(s[p].kind = s[p].kind.length ? s[p].kind : "captions"),
									s[p].label.length || delete s[p].label,
									o.tracks.push(s[p]));
						return o;
					};
				return r;
							...
							if (((d = e.childNodes[f]), d.prefix === l)) {
								...
								switch (o(d).toLowerCase()) {
									case "content":
										if (
											(r(d, "duration") &&
												(t.duration = n.seconds(r(d, "duration"))),
											r(d, "url"))
										) {
											t.sources || (t.sources = []);
											var g = {
									...
									case "subtitle":
										...
										(m.file = r(d, "url")),
											(m.kind = "captions"),
											r(d, "lang").length > 0 && (m.label = u(r(d, "lang"))),
											h.push(m);
								}
							}
		...
		(i = [n(22), n(2), n(4), n(3), n(1), n(13)]),
			(r = function (e, t, n, i, r, o) {
				...
				var l = function (l, u) {
					function c() {
						v ||
							((v = !0), (g = o.loaderstatus.COMPLETE), h.trigger(n.COMPLETE));
					}
					function d() {
						if (!y && ((u && 0 !== r.keys(u).length) || c(), !v)) {
							var i = l.getPlugins();
							(p = r.after(m, c)),
								r.each(u, function (r, a) {
									var s = e.getPluginName(a),
										l = i[s],
										u = l.getJS(),
										c = l.getTarget(),
										d = l.getStatus();
									d !== o.loaderstatus.LOADING &&
										d !== o.loaderstatus.NEW &&
										(u &&
											!t.versionCheck(c) &&
											h.trigger(n.ERROR, {
					...
					function f(e) {
						if (!y) {
							...
							e.url && t.log(i, e.url),
								this.off(),
								this.trigger(n.ERROR, { message: i }),
								d();
						}
					}
					var p,
					...
					(this.setupPlugins = function (n, i) {
						...
						r.each(c, function (i, l) {
							...
							if (p) {
								var v = r.extend(
									{ name: d, swf: p, pluginmode: f.getPluginmode() },
									i
								);
								o.push(v);
							}
	...
	function (e, t, n) {
		...
		(i = [n(1)]),
			(r = function (e) {
				return function (t) {
					return (
						e.each(Array.prototype.slice.call(arguments, 1), function (e) {
				...
				return e.extend(
					{
						get: function (e) {
							return (
								(this.attributes = this.attributes || {}), this.attributes[e]
							);
						},
						set: function (e, t) {
							if (
				...
				return (a = function (r) {
					function a() {
						if (o.isFinite(P.fontSize)) {
							...
							return e
								? void (j = (l.fontScale * P.fontSize) / l.fontSize)
								: void r.once("change:containerHeight", a);
						}
					}
					function u() {
						var e = r.get("containerHeight");
					...
					function d(e, n) {
						t.css("#" + e + " .jw-text-track-display", k, e),
					...
					function f(n, i) {
						e.isSafari() &&
							...
							t.css(
								"#" + n + " .jw-video::-webkit-media-text-track-display",
								k,
								n,
								!0
							),
					...
					function p(e, n) {
						(k.fontSize = n + "px"),
							t.css(
								"#" + e + " .jw-video::-webkit-media-text-track-display",
								k,
								e,
								!0
							);
					...
					function h(e, n) {
						...
						if (
							((i || r !== l.fontOpacity) &&
								(e.color = t.hexToRgba(i || "#ffffff", r)),
							n.back)
						) {
							var o = n.backgroundColor,
								a = n.backgroundOpacity;
							(o === l.backgroundColor && a === l.backgroundOpacity) ||
								(e.backgroundColor = t.hexToRgba(o, a));
					...
					function g(e, n, i) {
						...
						"dropshadow" === e
							? (n.textShadow = "0 2px 1px " + r)
							: "raised" === e
							? (n.textShadow =
									"0 0 5px " + r + ", 0 1px 5px " + r + ", 0 2px 5px " + r)
							: "depressed" === e
							? (n.textShadow = "0 -2px 1px " + r)
							: "uniform" === e &&
							  (n.textShadow =
					...
					(b = document.createElement("div")),
						...
						(this.populate = function (e) {
							if (!r.get("renderCaptionsNatively"))
								return (
									(w = []),
									(y = e),
									e
										? void this.selectCues(e, E)
										: ((w = []), void this.renderCues())
								);
						}),
						...
						(this.selectCues = function (e, t) {
							...
							e &&
								e.data &&
								t &&
								((i = this.getAlignmentPosition(e, t)),
								i !== !1 &&
									((n = this.getCurrentCues(e.data, i)),
									this.updateCurrentCues(n),
									this.renderCues(!0)));
						}),
						...
						(this.updateCurrentCues = function (e) {
							return (
								e.length
									? o.difference(e, w).length &&
									  (i.addClass(A, "jw-captions-window-active"), (w = e))
									: (w = []),
								w
							);
						}),
						...
						(this.setup = function (e, n) {
							(A = document.createElement("div")),
								...
								(A.className = "jw-captions-window jw-reset"),
								(L.className = "jw-captions-text jw-reset"),
								(P = o.extend({}, l, n)),
								(j = l.fontScale),
								a(P.fontSize);
							var i = P.windowColor,
							...
							h(f, P),
								(i || u !== l.windowOpacity) &&
									(k.backgroundColor = t.hexToRgba(i || "#000000", u)),
								g(d, f, P.fontOpacity),
								P.back || null !== d || g("uniform", f),
								s(A, k),
								s(L, f),
								c(e, f),
								A.appendChild(L),
						...
						r.mediaController.on("time seek", v, this),
						r.mediaController.on(
							"subtitlesTrackData",
							function () {
								this.selectCues(y, E);
					...
					return (
						(this.setup = function () {
							if (((d = i.extend({}, a, l.get("logo"))), d.file)) {
								(d.position = d.position || a.position),
									(d.hide = "true" === d.hide.toString()),
									c ||
										(c = t.createElement(
											(0, s["default"])(d.position, d.hide)
										)),
									l.set("logo", d),
									l.change("dock", u),
									l.on("change:controls", u),
									(f.onload = function () {
										var e = {
										...
										if (d.margin !== a.margin) {
											...
											3 === t.length &&
												((e["margin-" + t[1]] = d.margin),
												(e["margin-" + t[2]] = d.margin));
										}
					...
					return i
						? (this.setImage(null),
						  ...
						  void e.on(
								"change:state",
								function (e, t) {
									("complete" !== t && "idle" !== t && "error" !== t) ||
										(this.setImage(n.image),
										this.resize(null, null, e.get("stretching")));
								},
								this
						  ))
						: void this.setImage(n.image);
				}
				var r = function (e) {
					(this.model = e),
					...
					e.extend(r.prototype, {
						...
						setImage: function (n) {
							...
							e.isString(n) &&
								...
								(i.src = n)),
								t.style(this.el, { backgroundImage: r });
						},
						resize: function (e, n, i) {
							if ("uniform" === i) {
								if (
									(e && (this.playerAspectRatio = e / n),
								...
								if (r) {
									...
									Math.abs(this.playerAspectRatio - s) < 0.09 && (o = "cover");
								}
					...
					e.extend(n.prototype, {
						...
						update: function (e) {
							...
							if (o) {
								...
								"top-left" === o.position
									? (n.paddingLeft = s)
									: "top-right" === o.position && (n.paddingRight = s);
							}
							if (i && r && r.length) {
								var l = 56 * r.length;
				...
				return (function () {
					function o(t, a) {
						i(this, o),
							...
							(this.domElement = a),
							(this.model = t);
						var s = { enableDoubleTap: !0, useMove: !0 };
						this.ui = new e(a, r.extend(s, s)).on(
							{
								"click tap": this.clickHandler,
								"doubleClick doubleTap": function () {
									return this.alternateDoubleClickHandler
										? void this.alternateDoubleClickHandler()
										: void this.trigger("doubleClick");
								},
								move: function () {
									this.trigger("move");
								},
							...
							},
							{
								...
								value: function (e) {
									if (!this.model.get("flashBlocked"))
										return this.alternateClickHandler
											? void this.alternateClickHandler(e)
											: void this.trigger(
													e.type === t.touchEvents.CLICK ? "click" : "tap"
											  );
								},
							},
							{
	...
	function (e, t, n) {
		...
		function o() {
			(0, u.cancelAnimationFrame)(f),
				(f = (0, u.requestAnimationFrame)(function () {
		...
		document.addEventListener("visibilitychange", a),
			...
			window.addEventListener("beforeunload", function () {
				document.removeEventListener("visibilitychange", a),
					document.removeEventListener("webkitvisibilitychange", a),
	...
	function (e, t) {
		...
		function i(e, t) {
			...
			for (
				var a = e.getBoundingClientRect(), s = a, l = e.parentNode, u = !1;
				!u;
				...
				if (
					(l && 1 === l.nodeType
						? "visible" !== window.getComputedStyle(l).overflow && (c = t(l))
						: ((u = !0), (c = o)),
					c && ((s = r(c, s)), !s))
				)
					return 0;
		...
		function r(e, t) {
			...
			return (
				a >= 0 &&
				s >= 0 && { top: n, bottom: i, left: r, right: o, width: a, height: s }
			);
		}
	...
	function (e, t, n) {
		...
		(r = [
			...
			(o = function (e, t, i, r, o, a, u, d, p, m, y, w) {
				var E = r.style,
					b = r.bounds,
					A = r.isMobile(),
					L = r.isIE(),
				...
				return function (j, k) {
					...
					function _() {
						(0, g.cancelAnimationFrame)(ce),
							(ce = (0, g.requestAnimationFrame)(R));
					}
					function R() {
					...
					function x(e, t) {
						...
						if (o.isNumber(e) && o.isNumber(t)) {
							...
							var a = i < 2,
								...
								u = !n && s !== !1 && (s || a);
							r.toggleClass(Z, "jw-flag-small-player", a),
								r.toggleClass(Z, "jw-flag-time-slider-above", u),
								r.toggleClass(Z, "jw-orientation-portrait", t > e);
						}
					...
					function T(e, t, n) {
						if (e) {
							...
							r.css("#" + n + " .jw-color-active", i, n),
								r.css("#" + n + " .jw-color-active-hover:hover", i, n);
						}
						if (t) {
							var o = { color: t, borderColor: t, stroke: t };
							r.css("#" + n + " .jw-color-inactive", o, n),
								r.css("#" + n + " .jw-color-inactive-hover:hover", o, n);
						}
					}
					function S() {
								...
								tap: function () {
									...
									if (
										...
										if (
											...
											i.get("castActive") ||
											(i.mediaModel &&
												"audio" === i.mediaModel.get("mediaType"))
										)
											return;
										r.toggleClass(Z, "jw-flag-controls-hidden"),
											ie.renderCues(!0);
									} else
										ge && (ge.showing ? ge.userInactive() : ge.userActive());
								},
					...
					function W(e) {
						e.link
							...
							: k.get("controls") && j.play(P());
					}
					function F(e, t, n) {
						var i = r.exists(e),
							o = r.exists(t),
							a = { width: e };
						o && n && k.set("aspectratio", null),
							k.get("aspectratio") || (a.height = t),
							i && o && (k.set("width", e), k.set("height", t)),
							E(Z, a);
					}
					function J(e, t) {
						if (
							((e && !isNaN(1 * e)) || (e = k.get("containerWidth"))) &&
							((t && !isNaN(1 * t)) || (t = k.get("containerHeight")))
						) {
					...
					function B() {
						...
						return le
							? le.getVideo().getFullScreen()
							: k.getVideo().getFullScreen();
					}
					function V(e) {
						var t = k.get("fullscreen"),
							n = void 0 !== e.jwstate ? e.jwstate : B();
						t !== n && k.set("fullscreen", n),
							_(),
							clearTimeout(ue),
							(ue = setTimeout(J, 200));
					}
					function U(e, t) {
						t
							? (r.addClass(e, "jw-flag-fullscreen"),
							  E(document.body, { overflowY: "hidden" }),
							  ge && ge.userActive())
							: (r.removeClass(e, "jw-flag-fullscreen"),
							  E(document.body, { overflowY: "" })),
							J(),
							_();
					}
					function H() {
					...
					function z(e, t) {
						...
						r.toggleClass(Z, "jw-flag-media-audio", n),
							n && !o
								? Z.insertBefore(te.el, ee)
								: Z.insertBefore(te.el, ie.element());
					}
					function G(e, t) {
						if (!le) {
							var n = "LIVE" === t;
							r.toggleClass(Z, "jw-flag-live", n),
								$.setAltText(n ? e.get("localization").liveBroadcast : "");
						}
					}
					function q(e, t) {
						return t
							? void (t.name
									? ne.updateText(t.name, t.message)
									: ne.updateText(t.message, ""))
							: void ne.playlistItem(e, e.get("playlistItem"));
					}
					function K(e) {
						if (k.get("viewSetup")) {
							oe = e.get("state");
					...
					function Q(e) {
						switch (
							(k.get("controls") &&
								e !== t.PAUSED &&
								r.hasClass(Z, "jw-flag-controls-hidden") &&
								r.removeClass(Z, "jw-flag-controls-hidden"),
							r.replaceClass(Z, /jw-state-\S+/, "jw-state-" + e),
							e)
						) {
							case t.IDLE:
							case t.ERROR:
							...
							default:
								ie.show(),
									e === t.PAUSED && ge && !ge.showing && ie.renderCues(!0);
						}
					}
					function X() {
						!ge || le || A || ge.userActive();
					}
					var $ = o.extend(this, i, { isSetup: !1, api: j, model: k });
					...
					var Z = r.createElement(
							(0, s["default"])(k.get("id"), k.get("localization").player)
						),
					...
					(this.updateBounds = function () {
						...
						return n === ae && i === se
							? ((ae && se) || _(), void k.set("inDom", e))
							: ((n && i) || (ae && se) || _(),
							  (n || i || e) &&
									(k.set("containerWidth", n), k.set("containerHeight", i)),
							  k.set("inDom", e),
							  void (e && c["default"].observe(Z)));
					}),
						(this.updateStyles = function () {
							var e = k.get("containerWidth"),
								t = k.get("containerHeight");
							k.get("controls") && x(e, t),
								ge && ge.resize(e, t),
								J(e, t),
								ie.resize();
						}),
						(this.checkResized = function () {
							...
							if (t !== ae || n !== se) {
								(ae = t),
									(se = n),
									$.trigger(e.JWPLAYER_RESIZE, { width: t, height: n });
								var i = (0, v.getBreakpoint)(t);
								he !== i &&
									((he = i),
									$.trigger(e.JWPLAYER_BREAKPOINT, { breakpoint: he }));
							}
						}),
						(this.handleColorOverrides = function () {
							...
							if (
								(n &&
									...
									e(
										[".jw-option.jw-active-option", ".jw-progress"],
										"background",
										"none " + n
									)),
								i &&
								...
								if (
									(e([".jw-background-color"], "background", "none " + o),
									k.get("timeSliderAbove") !== !1)
								) {
									var a =
						...
						(this.setup = function () {
							var t = this;
							te.setup(Z.querySelector(".jw-preview")),
								ne.setup(Z.querySelector(".jw-title")),
								(re = new m(k)),
								re.setup(),
								re.setContainer(Z),
								re.on(e.JWPLAYER_LOGO_CLICK, W),
								ie.setup(Z.id, k.get("captions")),
								Z.insertBefore(ie.element(), ne.element()),
								(de = M(j, k, ee)),
								(pe = u(Z)),
								(fe = a(Z, document, V)),
								Z.addEventListener("focus", X),
								k.on("change:errorEvent", q),
								k.on("change:hideAdsControls", function (e, t) {
									r.toggleClass(Z, "jw-flag-ads-hide-controls", t);
								}),
								k.on("change:scrubbing", function (e, t) {
									r.toggleClass(Z, "jw-flag-dragging", t);
								}),
								k.mediaController.on("fullscreenchange", V),
								k.change("mediaModel", function (e, n) {
									n.change("mediaType", z, t),
										n.on(
											"change:visualQuality",
											function () {
												J();
											},
											t
								...
								k.change("skin", O, this),
								k.change("stretching", D),
								k.change("flashBlocked", Y);
							var i = k.get("width"),
								o = k.get("height");
							F(i, o),
								k.change("aspectratio", N),
								k.get("controls")
									? x(i, o)
									: r.addClass(Z, "jw-flag-controls-hidden"),
								C || ((C = !0), n(173)),
								L && r.addClass(Z, "jw-ie"),
								k.get("skin-loading") === !0 &&
									(r.addClass(Z, "jw-flag-skin-loading"),
									k.once("change:skin-loading", function () {
										r.removeClass(Z, "jw-flag-skin-loading");
									})),
								this.handleColorOverrides(),
								k.set("mediaContainer", ee),
								k.set("iFrame", r.isIframe()),
								k.set("activeTab", (0, h["default"])()),
								k.set(
									"touchMode",
									A && ("string" == typeof o || o >= l.CONTROLBAR_ONLY_HEIGHT)
								),
								c["default"].add(this),
								(this.isSetup = !0),
								k.set("viewSetup", !0),
								k.set("inDom", document.body.contains(Z));
						}),
						(this.init = function () {
							this.updateBounds(),
								k.change("state", K),
								k.on("change:fullscreen", me),
								k.on("change:activeTab", S),
								k.on("change:fullscreen", S),
								k.on("change:intersectionRatio", S),
								k.on("change:visibility", I),
								S(),
								1 !== c["default"].size() || k.get("visibility") || I(k, 1, 0),
								(ae = se = null),
								this.checkResized();
						});
					var ve = function (e, t) {
					...
					(this.addControls = function (e) {
						(ge = e),
							r.removeClass(Z, "jw-flag-controls-hidden"),
							k.change("streamType", G, this),
							e.enable(j, k),
							e.addActiveListeners(re.element());
						var n = e.logoContainer();
						n && re.setContainer(n),
							se && (x(ae, se), e.resize(ae, se), ie.renderCues(!0)),
							e.on("userActive userInactive", function () {
						...
						(this.removeControls = function () {
							re.setContainer(Z),
								ge &&
									(ge.removeActiveListeners(re.element()),
									ge.disable(),
									(ge = null));
							var e = document.querySelector(".jw-overlays");
							e && e.removeEventListener("mousemove", H),
								r.addClass(Z, "jw-flag-controls-hidden");
						});
					var me = function (e, t) {
						var n = k.getVideo();
						t && ge && k.get("autostartMuted") && ge.unmuteAutoplay(j, k),
							fe.supportsDomFullscreen()
								? (t ? fe.requestFullscreen() : fe.exitFullscreen(), U(Z, t))
								: L
								? U(Z, t)
								: (le && le.getVideo() && le.getVideo().setFullscreen(t),
								  n.setFullscreen(t)),
							n &&
								0 === n.getName().name.indexOf("flash") &&
								n.setFullscreen(t);
					};
					(this.resize = function (e, t) {
						...
						(this.resizeMedia = J),
						(this.setupInstream = function (e) {
							(this.instreamModel = le = e),
								le.on("change:controls", ve, this),
								le.on("change:state", K, this),
								r.addClass(Z, "jw-flag-ads"),
								ge && ge.userActive();
						}),
						...
						(this.destroyInstream = function () {
							if (
								(le && (le.off(null, null, this), (le = null)),
								this.setAltText(""),
								r.removeClass(Z, ["jw-flag-ads", "jw-flag-ads-hide-controls"]),
								k.set("hideAdsControls", !1),
								k.getVideo)
							) {
								var e = k.getVideo();
								e.setContainer(ee);
						...
						(this.getSafeRegion = function (e) {
							var t = { x: 0, y: 0, width: ae || 0, height: se || 0 };
							return (
								ge &&
									((e = e || !r.exists(e)),
									e && (t.height -= ge.controlbarHeight())),
								t
							);
						}),
						...
						(this.destroy = function () {
							c["default"].unobserve(Z),
								c["default"].remove(this),
								(this.isSetup = !1),
								this.off(),
								(0, g.cancelAnimationFrame)(ce),
								clearTimeout(ue),
								Z.removeEventListener("focus", X),
								pe && (pe.destroy(), (pe = null)),
								fe && (fe.destroy(), (fe = null)),
								k.mediaController &&
									k.mediaController.off("fullscreenchange", V),
								ge && ge.disable(),
								le && this.destroyInstream(),
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t["default"] = function (e) {
				...
				return (
					...
					'" class="jw-skin-' +
					t +
					' jw-error jw-reset"><div class="jw-title jw-reset">' +
					('<div class="jw-title-primary jw-reset">' + n + "</div>") +
					('<div class="jw-title-secondary jw-reset">' + i + "</div>") +
					'</div><div class="jw-display-container jw-reset"><div class="jw-display-icon-container jw-background-color jw-reset"><div class="jw-icon jw-icon-display jw-reset" aria-hidden="true"></div></div></div></div>'
				);
			});
	},
	function (e, t) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 }),
			(t["default"] = function (e) {
				...
				return (
					...
					t +
					'"><div class="jw-aspect jw-reset"></div><div class="jw-media jw-reset"></div><div class="jw-preview jw-reset"></div><div class="jw-title jw-reset"><div class="jw-title-primary jw-reset"></div><div class="jw-title-secondary jw-reset"></div></div><div class="jw-overlays jw-reset"></div></div>'
				);
			});
	},
	function (e, t, n) {
		...
		(i = [
			...
			(r = function (e, t, n, i, r, o, a, s, l, u, c, d, f, p, h, g) {
				var v = {};
				return (
					(v.api = e),
					(v._ = t),
					...
					(v.vid = u),
					(v.events = t.extend({}, c, { state: d })),
					(v.playlist = t.extend({}, f, { item: p })),
					(v.plugins = g),
					v
				);
			}.apply(t, i)),
	...
	function (e, t, n) {
		var i, r;
		(i = [n(85), n(14), n(161), n(25), n(23), n(1)]),
			(r = function (e, t, i, r, o, a) {
				var s = e.prototype.setup;
				return (
					(e.prototype.setup = function (e, l) {
						function u() {
							var e = p.get("cast");
						...
						function c() {
							var e = p.getVideo(),
								t = p.get("cast") || {};
							u()
								? ((!t.customAppId && r.containsDrm(p)) || d.apply(this),
								  f.apply(this))
								: e &&
								  e.video &&
								  (e.video.webkitWirelessVideoPlaybackDisabled = !0);
						}
						function d() {
							n.e(
								4,
								function (require) {
									if (window.chrome && o.isChrome()) {
										...
										(this._castController = new e(this, p)),
											(this.castToggle = this._castController.castToggle.bind(
												this._castController
											));
									}
								}.bind(this)
							);
								...
								n.e(
									...
									function (require) {
										...
										(this._airplayController = new e(this, p)),
											(this.castToggle =
												this._airplayController.airplayToggle.bind(
													this._airplayController
												));
									}.bind(this)
								);
						}
						...
						e.analytics &&
							(e.sdkplatform = e.sdkplatform || e.analytics.sdkplatform);
						var m = this;
						(l.getAdBlock = v.getAdBlock),
	...
	function (e, t, n) {
		var i, r;
		(i = [n(72), n(14), n(1), n(2), n(59), n(91), n(25)]),
			(r = function (e, t, i, r, o, a, s) {
				...
				function u(e, n) {
					...
					if (
						(s("ads") &&
							...
							(c.test(f.client)
								? (r[f.client] = f)
								: u.test(f.client) && (r[d + f.client + ".js"] = f),
							delete f.client),
						s("jwpsrv"))
					) {
					...
					if (!m) {
						...
						i.some(y, function (e) {
							if (e.stereomode && e.stereomode.length > 0)
								return l(r, n.get("vr") || {}, "vr.js"), !0;
						});
					}
					n.set("plugins", r), e();
				}
					...
					if ((i.set("key", s), i.set("edition", u), "unlimited" === u)) {
						...
						if (!c)
							return void a.error(
								...
								"Could not locate jwplayer.js script tag"
							);
						(n.p = c),
							(r.repo =
								o.repo =
					...
					i.updateProviders(),
						"invalid" === u
							? a.error(
									t,
									"Error setting up player",
									(void 0 === s ? "Missing" : "Invalid") + " license key"
							  )
							: t();
				}
				function d(e, t) {
				...
				function f() {
					var e = a.getQueue();
					return (
						(e.CHECK_KEY = { method: c, depends: ["LOAD_BASE64_POLYFILL"] }),
						(e.PROBE_DRM_SUPPORT = {
							method: d,
							depends: ["CHECK_KEY", "LOAD_PROMISE_POLYFILL"],
						}),
						(e.FILTER_PLUGINS = { method: u, depends: ["CHECK_KEY"] }),
	...
	function (e, t, n) {
		...
		var r,
			...
			a = n(164),
			s = i(a);
		(r = [n(2), n(4), n(6), n(3), n(1)]),
			(o = function (e, t, n, i, r) {
				var o = function (e) {
					(this.model = e), this.setup();
				};
				return (
					r.extend(o.prototype, i, {
						setup: function () {
							this.destroy(),
							...
							(this.el = e.createElement(t)),
								(this.skiptext =
									this.el.getElementsByClassName("jw-skiptext")[0]),
						...
						setWaitTime: function (t) {
							if (r.isString(t) && "%" === t.slice(-1)) {
								var n = parseFloat(t);
								return void (this.itemDuration && !isNaN(n)
									? (this.waitTime = (this.itemDuration * n) / 100)
									: (this.waitPercentage = t));
							}
							r.isNumber(t)
								? (this.waitTime = t)
								: "string" === e.typeOf(t)
								? (this.waitTime = e.seconds(t))
								: isNaN(Number(t))
								? (this.waitTime = 0)
								: (this.waitTime = Number(t));
						},
						skipAd: function () {
