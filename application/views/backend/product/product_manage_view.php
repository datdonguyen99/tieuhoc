<style>
    .thumbnail_preview{height: 96px; width: 128px;}
</style>

<h3 class='text-info'><i class="fa fa-pencil-square-o"></i> Quản lý sản phẩm</h3>
<div>
    <form action="" method='get'>
        <div class="clearfix row">
            ...
            <div class="col-sm-2">
                ...
                <input type="text" name="key" class="form-control" placeholder="Tìm theo tiêu đề" value="<?php echo $key ?>" />
            </div>
			<div class="col-sm-2">
				<label>Mã sản phẩm</label>
				<input type="text" name="ma_tin" class="form-control" placeholder="Tìm theo mã sản phẩm" value="<?php echo $ma_tin ?>" />
			</div>
...
<div>
    <table class="table table-bordered ">
        ...
        <?php foreach ($items as $e) {
			$cate = Category_model::SelectById($e->cate_id);
            $link = Product_model::GetLink($e);
            $u_name = "Admin";
            if($e->user_id>0){
            ...
            echo "<tr>
				...
				<td><a href='$link' target='_bank' >$e->name</a><br/>Tác giả: $u_name</td>
				<td><a href='$link' target='_bank' >$cate->name</a></td>
				<td><a href='$link' target='_bank' >$e->price</a></td>
				<td>
					<ul class='list-inline'>
