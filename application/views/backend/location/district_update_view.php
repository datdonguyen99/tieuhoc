	...
	<form action="" method="post">
		<div class="clearfix row form-group">
			...
			<div class="col-sm-6">
				...
				<input type="text" name='district_name' class='form-control' value='<?php echo isset($item->district_name) ? $item->district_name : '' ?>' />
			</div>
		</div>
		<div class='clearfix'>
...
<div>
	...
	<table class="table table-bordered" id="tbl-district">
		<tr>
		...
		<?php foreach ($items as $e) { ?>
			<tr>
				<td><a href="<?php echo $base_link .'/edit/'. $e->id ?>"><?php echo $e->district_name ?></a></td>
				<td>
					<ul class="list-inline">
