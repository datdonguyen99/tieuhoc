    ...
    var LobiboxNotify = function(type, options) {
        ...
        var me = this,
            ...
            _appendInWrapper = function($el, $wrapper) {
                if ("normal" === me.$options.size) $wrapper.append($el);
                else if ("mini" === me.$options.size) $el.addClass("notify-mini"), $wrapper.append($el);
