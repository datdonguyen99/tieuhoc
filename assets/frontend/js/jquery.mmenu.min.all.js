        ...
        e[t] = function(e, n, t) {
            ...
            openPanel: function(e) {
                ...
                if (n.hasClass(a.vertical)) {
                    ...
                    var s = this.$menu.children("." + a.panel),
                ...
                r.each(function() {
                    ...
                    if (!n.children("." + a.navbar).length && !s.hasClass(a.vertical)) {
                        ...
                        if (s.length) {
                            ...
                            o.append('<a class="' + a.btn + " " + a.prev + '" href="#' + r + '" data-target="#' + r + '"></a>').append('<a class="' + a.title + '"' + (_url ? ' href="' + _url + '"' : "") + ">" + l.text() + "</a>").prependTo(n), n.addClass(a.hasnavbar)
                        } else t.opts.navbar.title && (o.append('<a class="' + a.title + '">' + t.opts.navbar.title + "</a>").prependTo(n), n.addClass(a.hasnavbar))
                    }
                });
            ...
            _initAnchors: function() {
                ...
                r.$body.on(l.click + "-oncanvas", "a[href]", function(s) {
                    ...
                    if (l && s.preventDefault(), !l && d && i.is("." + a.listview + " > li > a") && !i.is('[rel="external"]') && !i.is('[target="_blank"]')) {
                        ...
                        var u = n.__valueOrFn(n.opts.onClick.preventDefault, i, "#" == c.slice(0, 1));
                        u && s.preventDefault(), n.__valueOrFn(n.opts.onClick.blockUI, i, !u) && r.$html.addClass(a.blocking), n.__valueOrFn(n.opts.onClick.close, i, u) && n.close()
                    }
                })
            },
...
! function(n) {
    ...
    n[t].addons[a] = {
        setup: function() {
            var r = this,
                i = this.opts[a];
            if (this.conf[a], s = n[t].glbl, "undefined" != typeof i) {
                ...
                n.each(i, function(s) {
                    ...
                    var d = o.position,
                        l = o.height;
                    "number" != typeof l && (l = 1), l = Math.min(4, Math.max(1, l)), "bottom" != d && (d = "top"), c[d] || (c[d] = 0), c[d]++;
                    var h = n("<div />").addClass(e.navbar + " " + e.navbar + "-" + d + " " + e.navbar + "-" + d + "-" + c[d] + " " + e.navbar + "-size-" + l);
                    c[d] += l - 1;
                    for (var f = 0, v = o.content.length; v > f; f++) {
                        var u = n[t].addons[a][o.content[f]] || !1;
                        u ? u.call(r, h, o) : (u = o.content[f], u instanceof n || (u = n(o.content[f])), u.each(function() {
                            h.append(n(this))
                        }))
                    }
                    var p = Math.ceil(h.children().not("." + e.btn).length / l);
                    p > 1 && h.addClass(e.navbar + "-content-" + p), h.children("." + e.btn).length && h.addClass(e.hasbtns), h.prependTo(r.$menu)
                });
                for (var o in c) r.$menu.addClass(e.hasnavbar + "-" + o + "-" + c[o])
            }
        },
        add: function() {
            e = n[t]._c, r = n[t]._d, i = n[t]._e, e.add("close hasbtns")
        },
        clickAnchor: function() {}
...
function(n) {
    var t = "mmenu",
        a = "navbars",
        e = "close";
    n[t].addons[a][e] = function(a) {
        var e = n[t]._c,
            r = n[t].glbl;
        a.append('<a class="' + e.close + " " + e.btn + '" href="#"></a>');
        var i = function(n) {
            a.find("." + e.close).attr("href", "#" + n.attr("id"))
        };
...
function(n) {
    ...
    n[t].addons[a][e] = function(a) {
        var e = n[t]._c,
            r = n('<div class="' + e.search + '" />').appendTo(a);
...
function(n) {
    var t = "mmenu",
        a = "navbars",
        e = "title";
    n[t].addons[a][e] = function(e, r) {
        var i = n[t]._c;
        e.append('<a class="' + i.title + '"></a>');
        var s = function(n) {
            n = n || this.$menu.children("." + i.current);
            var t = e.find("." + i.title),
